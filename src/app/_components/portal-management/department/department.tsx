        ...
        {!department.isLoading ? (
          <>
            {department.data && department.data.length > 0 ? (
              <div className="grid grid-cols-1 gap-4 px-4 pt-6 md:grid-cols-2 lg:grid-cols-4 pb-3">
                  ...
                  <Card className="grid grid-cols-3 border-gray-600/10 bg-gray-100 px-4">
                    <div className="col-span-2">
                      ...
                      <div className="flex flex-col  pt-2">
                        ...
                        <div className="px-4 text-xs font-semibold">{department.department_code}</div>
                      </div>
                    ...
                    <div className="col-span-1 flex flex-col items-center justify-center gap-2 py-3 px-7 pb-2">
