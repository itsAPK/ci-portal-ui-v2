...
import { CartesianGrid, XAxis, Bar, LabelList,BarChart, LineChart, Line,AreaChart,Area } from "recharts";
...
export const OpportunityByStatus = () => {
 const beltsQuery = useQuery({
    ...
    queryFn: async () => {
      return await api
        .get(`/opportunity/count/by_status`)
        .then((res) => {
          if (!res.data.success) {
    ...
    <Card className="border-primary/50">
      ...
      <CardContent className="overflow-x-auto">
        {!beltsQuery.isLoading ? (
          <ChartContainer config={chartConfig} className="h-[200px] w-[1400px]">
            <AreaChart
              accessibilityLayer
              ...
              <XAxis dataKey="_id" className="capitalize" tickLine={false} tickMargin={10} axisLine={false} />
